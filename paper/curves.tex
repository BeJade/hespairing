...
Therefore, we will generate pairing-friendly (twisted) Hessian curves is to
...
Recall that we focus only on curves that both the curves and their_{•} twists contain points of order 3.
...
This means that $r(x_0)$ factors, and the largest prime-order subgroup of $E(\FF_{q})$ is actually has less than $r(x_0)$ elements.
