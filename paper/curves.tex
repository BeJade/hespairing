...
%To compensate, a pairing implementation using embedding degree 18 aiming for 192-bit security would have to increase the size of the base field to about 653 bits.
...
%$\log(q) \approx 384$, and
%$\log(L_{q^{15}}[1/3, 1.526]) \approx 143$,
