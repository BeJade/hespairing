...
Note that $l_{R,P}$ is a notation for the line passing through $R$ and $P$ and that
$v_{R}$ is a notation for the line passing through $R$ and $-R$.
...
In paritcular, the line $v_R$ has a particularly simple form, meaning that very often
...
generated by $\omega$ amounts to $\sqr$ to compute $U = X_1^2$ plus two multiplications of an $\F{q}$-element
